...
```{r d0, message = FALSE, warning = FALSE, echo = FALSE, fig.align = 'center', fig.width = 8, cache = TRUE}
# make data
data <- tibble(
  Treatment = c("T", "C"),
  t0 = c(2,1),
...
kbl(data, linesep = "",  col.names = linebreak(c("Treatment", "Time 0", "Time 1")), align = "c", caption = "<center><strong>2x2 DiD</strong></center>", table.attr = "style='width:30%;'") %>%
  kable_styling(bootstrap_options = "bordered", full_width = T) %>%
  kable_styling(font_size = 12, position = "center") %>% 
  kable_styling(latex_options = "hold_position") %>%
  column_spec(2, background = ifelse(data$t0 > 4, "lightblue", "lightpink")) %>%
  column_spec(3, background = ifelse(data$t1 > 4, "lightblue", "lightpink")) 
```
