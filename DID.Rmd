...
- In this example, $\color{maroon}{\delta}$ is the weighted average of the four 2x2 treatment effects. The weights are a function of the <span style="color:maroon"> size of the sub-sample, relative size of treatment and control groups, and treatment variance in the sub-sample </span>.
